...
function eyePos() {
	eyes.forEach((eye, i) => {
		...
		let marginX =
			enzoFace.getBoundingClientRect().left +
			eyeWidth / 2 +
			([(163 * faceHeight) / 687, (347 * faceHeight) / 687][i] - 28);
		...
		eye.style.backgroundSize =
			(eyeHeight * faceHeight) / 687 +
			'px ' +
			(eyeWidth * faceWidth) / 619 +
			'px';
